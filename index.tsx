...
import { InputProps, OTPInputViewState } from 'OTPInputView';
import { codeToArray, isAutoFillSupported } from 'app/utils/helpers';
...
> {
  ...
  constructor(props: InputProps) {
    ...
    this.state = {
      ...
      // selectedIndex: props.autoFocusOnLoad ? 0 : -1, 0
      selectedIndex: 0,
    };
  }
  ...
  renderOneInputField = (_: TextInput, index: number) => {
    ...
    const { defaultTextFieldStyle } = OtpStyles;
      ...
      <View pointerEvents="none" key={index + 'view'} testID="inputSlotView">
        <TextInput
          ...
          style={{
            ...defaultTextFieldStyle,
            ...codeInputFieldStyle,
            ...(selectedIndex === index && codeInputHighlightStyle),
            ...(digits[index] !== undefined && filledCodeInputFieldStyle),
          }}
          ref={ref => {
          ...
          {...(index === 0 && { autoFocus: this.props.autoFocusOnLoad })}
        />
      </View>
    );
  };
